...
class GptOssResponseParser(ResponseParser):
    ...
    def _maybe_inject_tool_grammar(self):
        ...
        if has_tools:
            ...
            # tool grammar failed — tools are already in the prompt;
            # do not fall through to response_format grammar
            return
    ...
    @staticmethod
    def _build_tool_grammar(tools, tool_choice):
        ...
        # Tools are already model_dump'd dicts at this point.
    ...
    @staticmethod
    def _build_response_format_grammar(fmt):
        ...
        if fmt_type == 'json_schema':
            ...
            elif schema is not None and hasattr(schema, 'schema') and schema.schema is not None:
                raw = schema.schema
            else:
                raw = {'type': 'object'}
    ...
    def _set_response_format(self, grammar: dict):
